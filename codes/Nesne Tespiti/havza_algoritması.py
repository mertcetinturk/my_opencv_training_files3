...
# contour
contour, hierarchy = cv2.findContours(coin_thresh, cv2.RETR_CCOMP, cv2.CHAIN_APPROX_SIMPLE)

for i in range(len(contour)):
    if hierarchy[0][i][3] == -1:  # external şartı
        cv2.drawContours(coin, contour, i, (0, 255, 0), 10)
